...
test('orientation.onchange', function (t) {
  ...
  orientation.onchange = function (changeEvt) {
    t.equal(
      changeEvt.target,
      orientation,
      'evt.target should be the orientation object'
    );
    t.equal(
      changeEvt.currentTarget,
      orientation,
      'evt.currentTarget should be the orientation object'
    );
...
test('orientation type', function (t) {
  ...
  t.equal(
    typeof orientation.type,
    'string',
    'orientation.type should be a string'
  );
});
